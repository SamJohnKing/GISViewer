...
//                }
                ...
                return "Success::";
            } else if (Command.equals("ListenLWJGLKey")) {//要注意多线程冲突，已使用信号量自锁解决
                ...
                return res ;
            } else if (Command.equals("ListenClick")) {//要注意多线程冲突，已使用信号量自锁解决
                Double WaitSecond = 30.0;
                if(!str.isEmpty()) WaitSecond = Double.parseDouble(str);
                ...
                MapWizard.SingleItem.ClickBehaviorListened = null;
                return res;
            } else if (Command.equals("ListenClick&Key")) {//要注意多线程冲突，已使用信号量自锁解决
                Double WaitSecond = 30.0;
                if(!str.isEmpty()) WaitSecond = Double.parseDouble(str);
                final ExternalListener OriginalListener = MapWizard.SingleItem.BehaviorListener;
                MapWizard.SingleItem.ClickBehaviorListened = null;
